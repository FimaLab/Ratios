...
def calculate_metabolite_ratios_zebra(data):
    missing_columns = []
    calculated_ratios = []
    skipped_ratios = []
    successful_ratios = []
    ...
    if check_columns(['DOPA', 'Dopamine'], 'DOPA / Dopamine'):
        ratios_data['DOPA / Dopamine'] = data['DOPA']/data['Dopamine']
        calculated_ratios.append('DOPA / Dopamine')

    if check_columns(['Dopamine', 'Norepinephrine'], 'Dopamine / Norepinephrine'):
        ratios_data['Dopamine / Norepinephrine'] = data['Dopamine']/data['Norepinephrine']
        calculated_ratios.append('Dopamine / Norepinephrine')
    
    if check_columns(['Norepinephrine', 'Epinephrine'], 'Norepinephrine / Epinephrine'):
        ratios_data['Norepinephrine / Epinephrine'] = data['Norepinephrine']/data['Epinephrine']
        calculated_ratios.append('Norepinephrine / Epinephrine')
    
    if check_columns(['Metanephrine', 'Epinephrine'], 'Metanephrine / Epinephrine'):
        ratios_data['Metanephrine / Epinephrine'] = data['Metanephrine'] / data['Epinephrine']
        calculated_ratios.append('Metanephrine / Epinephrine')
    
    if check_columns(['Normetanephrine', 'Norepinephrine'], 'Normetanephrine / Norepinephrine'):
        ratios_data['Normetanephrine / Norepinephrine'] = data['Normetanephrine'] / data['Norepinephrine']
        calculated_ratios.append('Normetanephrine / Norepinephrine')
    
    if check_columns(['Dopamine', 'Serotonin'], 'Dopamine / Serotonin'):
        ratios_data['Dopamine / Serotonin'] = data['Dopamine'] / data['Serotonin']
        calculated_ratios.append('Dopamine / Serotonin')
    
    if check_columns(['Glutamine', 'Glutamic acid'], 'Glutamine / Glutamic acid'):
        ratios_data['Glutamine / Glutamic acid'] = data['Glutamine'] / data['Glutamic acid']
        calculated_ratios.append('Glutamine / Glutamic acid')
