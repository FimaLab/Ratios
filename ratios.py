...
def calculate_metabolite_ratios(data):  
  ...
  data['Ratio of AC-OHs to ACs']=(data['C3-OH']+data['C4-OH']+data['C5-OH']+data['C14-1-OH']+
                                  data['C14-2-OH']+data['C14-OH']+data['C16-1-OH']+
                                  data['C16-2-OH']+data['C16-OH']+data['C18-1-OH']+data['C18-OH'])/
                                  (data['C0']+ data['C10']+ data['C10-1'] +data['C10-2']+
       data['C12']+data['C12-1']+data['C14']+ data['C14-1']+ data['C14-2']+data['C16']+data['C16-1']+data['C18']+data['C18-1']+ data['C18-2']+
                                   data['C2']+data['C3']+data['C4']+data['C5']+ data['C5-1']+ data['C5-DC']+ data['C6'],
                                   data['C6-DC'], data['C8'] + data['C8-1'])                    
  data['SBCAD Deficiency (NBS)']=data['C5']/data['C0']
  data['SCAD Deficiency (NBS)']=data['C4']/data['C3']
  data['Sum of ACs']=data['C3-OH']+data['C4-OH']+data['C5-OH']+data['C14-1-OH']+
                                  data['C14-2-OH']+data['C14-OH']+data['C16-1-OH']+
                                  data['C16-2-OH']+data['C16-OH']+data['C18-1-OH']+data['C18-OH']+
                                  data['C0']+ data['C10']+ data['C10-1'] +data['C10-2']+
       data['C12']+data['C12-1']+data['C14']+ data['C14-1']+ data['C14-2']+data['C16']+data['C16-1']+data['C18']+data['C18-1']+ data['C18-2']+
                                   data['C2']+data['C3']+data['C4']+data['C5']+ data['C5-1']+ data['C5-DC']+ data['C6'],
                                   data['C6-DC'], data['C8'] + data['C8-1']
  data['Sum of MUFA-ACs']=data['C14-1-OH']+data['C16-1-OH']+data['C18-1-OH']+data['C10-1'] +data['C12-1']+
                           data['C14-1']+ data['C16-1']+ data['C18-1']+data['C8-1'] + data['C5-1']                     
  data['Sum of PUFA-ACs']=data['C14-2-OH']+data['C16-2-OH']+data['C10-2']+data['C14-2']+data['C18-2']+
  #data['Sum of SFA-ACs']=
